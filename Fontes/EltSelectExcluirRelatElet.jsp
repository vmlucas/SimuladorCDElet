                    ...
                    <td width="770"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr valign="top">
                          <td height="414"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <table width="462" border="0" cellspacing="0" cellpadding="0" align="center">
                                <tr>
                                  <td width="462" valign="top"><table width="415" border="0" cellspacing="0" cellpadding="0" align="center" height="300">
                                      <tr valign="top">
                                        <td colspan="2" height="15"><img src="./img/simulador_top.gif" width="417" height="19"></td>
                                      </tr>
                                      <tr align="center" valign="top">
                                        <td colspan="2" background="./img/simulador_fundo.gif"><table width="400" height="60" border="0" cellpadding="0" cellspacing="3" background="./img/nada.gif">
                                            <tr>
                                              <td width="144" height="22" colspan="2" valign="top"></td>
                                            </tr>
                                            <tr>
                                              <td colspan="2"><p><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#336699"><b>Por favor, selecione uma simula&ccedil;&atilde;o para ser exclu&iacute;da.</b></font></p></td>
                                            </tr>
                                        </table></td>
                                      </tr>
                                      <tr>
...
<tr> 
                ...
                <tr> 
                  <td colspan="2"><p><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#336699"><b>Por 
                    favor, selecione uma simula&ccedil;&atilde;o para ser exclu&iacute;da.</b></font></p>
                  </td>
                </tr>
              </table></td>
          </tr>
          <tr> 
            <td valign="top"> <a href="javascript:history.back()"><img src="img/simulador_voltar.gif" width="67" height="38" border="0"> 
              </a> </td>
            <td valign="top"> <input type="Image" src="img/simulador_baixo05.gif" border="0" width="350" height="38"> 
            </td>
          </tr>
